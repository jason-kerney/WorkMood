...
public interface ILineGraphService
{
    ...
    /// <param name="showTrendLine">Whether to show the trend line</param>
    /// <param name="lineColor">Color for the graph line</param>
    /// <param name="backgroundColor">Solid background color for the graph</param>
    /// <param name="width">Width of the graph in pixels</param>
    /// <param name="height">Height of the graph in pixels</param>
    /// <returns>PNG image data as byte array</returns>
    ...
    Task SaveGraphAsync(IEnumerable<MoodEntry> moodEntries, GraphMode graphMode, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string filePath, Color lineColor, int width = 800, int height = 600, GapDisplayMode gapDisplayMode = GapDisplayMode.ShowGaps, GapSegmentSecondaryPenMode? gapSegmentSecondaryPenMode = null);

    /// <summary>
    /// Saves a line graph PNG image with a solid background color for the specified graph mode
    /// </summary>
    /// <param name="moodEntries">The mood entries to graph</param>
    /// <param name="graphMode">The mode of the graph (Impact, Average, or RawData)</param>
    /// <param name="dateRange">The date range for the graph</param>
    ...
    /// <param name="height">Height of the graph in pixels</param>
    /// <returns>Task representing the async operation</returns>
    Task SaveGraphAsync(IEnumerable<MoodEntry> moodEntries, GraphMode graphMode, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string filePath, Color lineColor, Color backgroundColor, int width = 800, int height = 600, GapDisplayMode gapDisplayMode = GapDisplayMode.ShowGaps, GapSegmentSecondaryPenMode? gapSegmentSecondaryPenMode = null);
    ...
    /// <param name="height">Height of the graph in pixels</param>
    /// <returns>Task representing the async operation</returns>
    Task SaveGraphAsync(IEnumerable<MoodEntry> moodEntries, GraphMode graphMode, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string filePath, string backgroundImagePath, Color lineColor, int width = 800, int height = 600, GapDisplayMode gapDisplayMode = GapDisplayMode.ShowGaps, GapSegmentSecondaryPenMode? gapSegmentSecondaryPenMode = null);
}