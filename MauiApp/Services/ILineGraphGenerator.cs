...
public interface ILineGraphGenerator
{
    ...
    /// <param name="title">The title to display on the graph (when showTitle is true)</param>
    ...
    Task<byte[]> GenerateLineGraphAsync(IEnumerable<GraphDataPoint> dataPoints, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, Color lineColor, AxisRange yAxisRange, string title, int width = 800, int height = 600);
    ...
    /// <param name="height">Height of the graph in pixels</param>
    /// <returns>PNG image data as byte array</returns>
    Task<byte[]> GenerateLineGraphAsync(IEnumerable<GraphDataPoint> dataPoints, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string backgroundImagePath, Color lineColor, AxisRange yAxisRange, string title, int width = 800, int height = 600);
    ...
    Task SaveLineGraphAsync(IEnumerable<GraphDataPoint> dataPoints, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string filePath, Color lineColor, AxisRange yAxisRange, string title, int width = 800, int height = 600);
    ...
    /// <param name="height">Height of the graph in pixels</param>
    /// <returns>Task representing the async operation</returns>
    Task SaveLineGraphAsync(IEnumerable<GraphDataPoint> dataPoints, DateRangeInfo dateRange, bool showDataPoints, bool showAxesAndGrid, bool showTitle, bool showTrendLine, string filePath, string backgroundImagePath, Color lineColor, AxisRange yAxisRange, string title, int width = 800, int height = 600);
}