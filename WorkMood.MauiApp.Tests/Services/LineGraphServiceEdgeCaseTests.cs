...
//         var sparseMoodEntries = new List<MoodEntry>
//         {
//             new() { Date = new DateOnly(2025, 1, 15), StartOfWork = 5, EndOfWork = 7, CreatedAt = new DateTime(2025, 1, 15, 8, 0, 0), LastModified = new DateTime(2025, 1, 15, 17, 0, 0) },
//             new() { Date = new DateOnly(2025, 1, 16), StartOfWork = 6, EndOfWork = 4, CreatedAt = new DateTime(2025, 1, 16, 8, 30, 0), LastModified = new DateTime(2025, 1, 16, 16, 30, 0) },
//             new() { Date = new DateOnly(2025, 1, 17), StartOfWork = 6, EndOfWork = 4, CreatedAt = new DateTime(2025, 1, 17, 8, 30, 0), LastModified = new DateTime(2025, 1, 17, 16, 30, 0) },
//             new() { Date = new DateOnly(2025, 1, 18), StartOfWork = 6, EndOfWork = 4, CreatedAt = new DateTime(2025, 1, 18, 8, 30, 0), LastModified = new DateTime(2025, 1, 18, 16, 30, 0) },
//             new() { Date = new DateOnly(2025, 1, 19), StartOfWork = 6, EndOfWork = 4, CreatedAt = new DateTime(2025, 1, 19, 8, 30, 0), LastModified = new DateTime(2025, 1, 19, 16, 30, 0) }
//         };
//         var wideRange = DateRange.LastMonth;
...
//     {
//         // Arrange - Daily entries for a month
//         var denseMoodEntries = new List<MoodEntry>();
//         var startDate = new DateOnly(2025, 1, 1);
        
//         for (int i = 0; i < 31; i++)
//         {
//             var date = startDate.AddDays(i);
//             var startMood = 3 + (i % 6); // Varies from 3 to 8
//             var endMood = startMood + (int)(Math.Sin(i * 0.5) * 3); // Creates wave pattern
//             endMood = Math.Clamp(endMood, 1, 10);
            
//             denseMoodEntries.Add(new MoodEntry 
//             { 
//                 Date = date, 
